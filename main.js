...
const contractAddress="0x8cA10660e913987bcd88eB8C8fB55F0c07aE2a2e";
let contractAbi=[
    {
      "inputs": [
        {
...
const getAllCandidates=async()=>{
    ...
    p3.innerHTML="Please wait , getting all the candidates from the mart contract";
...
const voteStatus=async()=>{
  if (WALLET_CONNECTED!=0){
    ...
    const signer=provider.getSigner();
    const contractInstance=new ethers.Contract(contractAddress,contractAbi,signer);
    var currentStatus=await contractInstance.getVotingStatus();
    ...
    var status=document.getElementById("status");
    status.innerHTML="Please connect the metamask first";
  }
}
...
const addVote=async()=>{
  if (WALLET_CONNECTED!=0){
    ...
    cand.innerHTML="Please wait adding the vote in the smart contract";
